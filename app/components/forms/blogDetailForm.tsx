...
export const BlogDetailForm: React.FC<BlogDetailFormProps> = ({
  ...
  return (
    <div className="p-3 max-w-4xl space-y-2 rounded" dir="rtl">
        ...
        <div className=" animate-slideDown">
          ...
          <div className="grid grid-cols-1 mb-4">
            ...
            <DynamicRangeInput
              ...
              min="0"
              max="100"
              value={userInputData?.setting?.titleFontSize?.toString() ?? "0"}
              onChange={handleSettingChange}
            />
            <ColorInput
              label="رنگ عنوان"
          ...
          {/* content */}
          <div className="grid grid-cols-1  mb-4 rounded-lg">
            <h3 className="font-semibold text-sky-700 ">تنظیمات محتوا</h3>
            <DynamicRangeInput
              label="سایز"
              name="contentFontSize"
              min="0"
              max="100"
              value={userInputData?.setting?.contentFontSize?.toString() ?? "0"}
              onChange={handleSettingChange}
            />
            <ColorInput
              label="رنگ متن محتوا"
          ...
          <div className="grid grid-cols-1 gap-4 rounded-lg">
            <h3 className="font-semibold text-sky-700 ">تنظیمات تصویر</h3>
            <DynamicRangeInput
              label="عرض"
              name="coverImageWidth"
              min="0"
              max="800"
              value={userInputData?.setting?.coverImageWidth?.toString() ?? "0"}
              onChange={handleSettingChange}
            />
            <DynamicRangeInput
              label="ارتفاع"
              ...
              max="1500"
              value={
                userInputData?.setting?.coverImageHeight?.toString() ?? "0"
              }
              onChange={handleSettingChange}
            />
            ...
            <DynamicRangeInput
              ...
              min="0"
              max="100"
              value={userInputData?.setting?.imageRadius?.toString() ?? "0"}
              onChange={handleSettingChange}
            />
          </div>
          {/* author and date */}
          <div className="grid grid-cols-1 gap-4 mt-4 rounded-lg">
            ...
            <DynamicRangeInput
              ...
              min="0"
              max="100"
              value={userInputData?.setting?.metaFontSize?.toString() ?? "0"}
              onChange={handleSettingChange}
            />
      ...
      {/* Animation */}
      {isAnimationOpen && (
        <div className="rounded-lg flex flex-col gap-3 border-t pt-4 mt-6 animate-slideDown">
          {/* Header with Toggle */}
