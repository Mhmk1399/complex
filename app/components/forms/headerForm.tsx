...
export const HeaderForm: React.FC<HeaderFormProps> = ({
  ...
  return (
    ...
    // </div>
    <div
      className="p-3 max-w-4xl space-y-2 mx-4  rounded mt-4"
      dir="rtl"
    >
      ...
      <div className="flex gap-2 mb-4 border-b border-gray-200">
        <button
          ...
          className={`px-4 py-2 text-sm  rounded-t-lg transition-all duration-200 relative ${
            isContentOpen
              ? "text-blue-600 font-bold border-gray-200 "
