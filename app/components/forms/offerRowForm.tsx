    ...
    <div className="p-3 max-w-4xl mx-auto bg-gray-200 rounded-xl my-4" dir="rtl">
      ...
      <div className="mb-6 bg-white rounded-xl shadow-sm border border-gray-100">
        ...
        >
          ...
          <svg className={`w-5 h-5 text-gray-400 transition-transform duration-200 ${isContentOpen ? "rotate-180" : ""}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div className="p-3 bg-gray-50 rounded-lg space-y-3">
      ...
      <div className="mb-6 bg-white rounded-xl shadow-sm border border-gray-100">
        ...
        >
          ...
          <svg className={`w-5 h-5 text-gray-400 transition-transform duration-200 ${isStyleSettingsOpen ? "rotate-180" : ""}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" />
          </svg>
        </button>
      ...
      <ColorInput
        ...
        value={userInputData?.blocks?.setting?.buttonTextColor || '#000000'}
        onChange={(e) => {
            if (isUpdating) return;
            setIsUpdating(true);
      ...
      <div className="mb-6 bg-white rounded-xl shadow-sm border border-gray-100">
        ...
        >
          ...
          <svg className={`w-5 h-5 text-gray-400 transition-transform duration-200 ${isSpacingOpen ? "rotate-180" : ""}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" />
          </svg>
        </button>
