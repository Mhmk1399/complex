...
export const SlideForm: React.FC<SlideFormProps> = ({ setUserInputData, userInputData, layout }) => {
  ...
  const handleBlockChange = (e: React.ChangeEvent<HTMLInputElement | HTMLTextAreaElement>, index: number, field: string) => {
        ...
        <div key={index} className="mb-8 p-4 border rounded">
          ...
          <div className="space-y-4">
            <div>
              ...
              <input
                type="text"
                value={userInputData?.blocks?.[index]?.imageSrc || ''}
            ...
            <div>
              ...
              <input
                type="text"
                value={userInputData?.blocks?.[index]?.text || ''}
            ...
            <div>
              ...
              <textarea
                value={userInputData?.blocks?.[index]?.description || ''}
            ...
            <div>
              ...
              <input
                type="text"
                value={userInputData?.blocks?.[index]?.btnText || ''}
            ...
            <div>
              ...
              <input
                type="text"
                value={userInputData?.blocks?.[index]?.btnLink || ''}
