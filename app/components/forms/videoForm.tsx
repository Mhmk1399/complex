      ...
      <div className="mb-6">
        ...
        <div className=" space-y-4">
          <ColorInput
            label="Heading Color"
            name="headingColor"
            value={userInputData.blocks.setting?.headingColor?.toString() ?? '#000000'}
            onChange={handleBlockSettingChange}
          />
          <ColorInput
            label="Background Color"
            name="backgroundVideoSection"
            value={userInputData.blocks.setting?.backgroundVideoSection?.toString() ?? '#e4e4e4'}
            onChange={handleBlockSettingChange}
          />
          ...
          <div>
            ...
            <input
              ...
              value={userInputData.blocks.setting?.headingFontSize?.toString() ?? '30px'}
              onChange={handleBlockSettingChange}
              className="w-full p-2 border rounded"
            />
          </div>
          ...
          <div>
            ...
            <select
              ...
              value={userInputData.blocks.setting?.headingFontWeight?.toString() ?? 'bold'}
              onChange={handleBlockSettingChange}
              className="w-full p-2 border rounded"
            >
          ...
          <div>
            ...
            <input
              type="range"
              name="videoWidth"
              value={userInputData.blocks.setting?.videoWidth?.toString() ?? '1000px'}
              onChange={handleBlockSettingChange}
              className="w-full p-2 border rounded"
            />
          </div>
          ...
          <div>
            ...
            <input
              type="range"
              name="videoRadious"
              value={userInputData.blocks.setting?.videoRadious?.toString() ?? '20px'}
              onChange={handleBlockSettingChange}
              className="w-full p-2 border rounded"
            />
          </div>
          ...
          <div>
            ...
            <input
              type="text"
              name="videoPoster"
              value={userInputData.blocks.setting?.videoPoster?.toString() ?? ''}
              onChange={handleBlockSettingChange}
              className="w-full p-2 border rounded"
            />
          </div>
