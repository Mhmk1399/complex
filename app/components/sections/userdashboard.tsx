...
const Dashboard = () => {
  return (
    <>
      <main className="p-6 sm:p-10 space-y-6" dir="rtl">
        <div className="flex flex-col p-2 border-b border-black/20 space-y-6 md:space-y-0 md:flex-row justify-between">
          <div className="mr-6">
            <h1 className="text-4xl font-semibold mb-2">Dashboard</h1>
            <h2 className="text-blue-600 text-xl font-bold ml-0.5">
